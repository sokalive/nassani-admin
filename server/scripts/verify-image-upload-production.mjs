 ...
 *   API=https://api.nassanitv.online ADMIN_API_TOKEN=... node server/scripts/verify-image-upload-production.mjs
 */
const API = String(process.env.API || process.env.VPS_API || 'https://api.nassanitv.online').replace(/\/$/, '')
