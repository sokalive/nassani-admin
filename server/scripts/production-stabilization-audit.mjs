 ...
 *   VPS_API=https://api.nassanitv.online ADMIN_TOKEN=... node scripts/production-stabilization-audit.mjs
 */
...
const RENDER_API =
  String(process.env.RENDER_API || 'https://api.nassanitv.online').replace(/\/+$/, '') + '/api'
