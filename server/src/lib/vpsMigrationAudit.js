...
function buildConclusions(matrix, totalTelemetry, vpsTotal, renderTotal) {
  ...
  return {
    ...
    render_stopped_observation:
      'If Render was stopped and users still streamed, they were either hitting VPS (api.nassanitv.online), using cached channel/subscription data briefly, or playback via URLs already pointing at VPS/Bunny — not proof that Render is unused for all versions.',
  }
}
